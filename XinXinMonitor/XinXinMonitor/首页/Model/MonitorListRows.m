...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.lixianTime = [self objectOrNilForKey:kMonitorListRowsLixianTime fromDictionary:dict];
            ...
            self.lxMessageStatus = [self objectOrNilForKey:kMonitorListRowsLxMessageStatus fromDictionary:dict];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:self.lixianTime forKey:kMonitorListRowsLixianTime];
    ...
    [mutableDict setValue:self.lxMessageStatus forKey:kMonitorListRowsLxMessageStatus];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.lixianTime = [aDecoder decodeObjectForKey:kMonitorListRowsLixianTime];
    ...
    self.lxMessageStatus = [aDecoder decodeObjectForKey:kMonitorListRowsLxMessageStatus];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_lixianTime forKey:kMonitorListRowsLixianTime];
    ...
    [aCoder encodeObject:_lxMessageStatus forKey:kMonitorListRowsLxMessageStatus];
...
- (id)copyWithZone:(NSZone *)zone
{
    ...
    if (copy) {
        ...
        copy.lixianTime = [self.lixianTime copyWithZone:zone];
        ...
        copy.lxMessageStatus = [self.lxMessageStatus copyWithZone:zone];
